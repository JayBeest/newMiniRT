...
void	init_new_rt(t_rt_scene *scene)
{
	...
	scene->spot_lights[0].intensity = 0.3f;
	scene->spot_lights[0].color = (t_rt_color){255, 255, 255, 255};
	scene->spot_lights[1].coordinates = (t_rt_vector){0.8f, 15, -3.5f};
	scene->spot_lights[1].intensity = 0.3f;
	scene->spot_lights[1].color = (t_rt_color){255, 255, 255, 255};
	scene->spot_lights[2].coordinates = (t_rt_vector){2, 0, -3};
	scene->spot_lights[2].intensity = 0.6f;
	scene->spot_lights[2].color = (t_rt_color){255, 255, 255, 255};
	...
	scene->objects[0].sphere.specular = 0.16f;
	scene->objects[1].sphere.type = SPHERE;
	...
	scene->objects[1].sphere.specular = 0.45f;
	...
	scene->objects[2].sphere.specular = 0.9f;
	...
	scene->objects[3].sphere.specular = 0.6f;
	...
	scene->objects[4].sphere.specular = 0.6f;
}
