...
void	init_new_rt(t_rt_scene *scene)
{
	...
	scene->spot_lights[2].intensity = 0.6;
	...
	scene->objects[0].sphere.specular = 0.16;
	scene->objects[1].sphere.type = SPHERE;
	...
	scene->objects[1].sphere.specular = 0.45;
	...
	scene->objects[2].sphere.specular = 0.9;
	...
	scene->objects[4].sphere.radius = 195.0 / 2;
